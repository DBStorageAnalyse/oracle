...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Oracle 数据库碎片工具  V%s" % self.version))
    ...
    def aa_1(self, press):
        if press == 100:
            time.sleep(2)
            link_wl = ora_link1.Link_wl(self)  # 页面拼接 *****
